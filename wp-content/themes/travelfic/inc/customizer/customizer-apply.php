...
<style>
    ...
    .tft-design-2 .tft-footer-sections .tft-grid table caption,
    .tft-design-2 .tft-footer-sections .tft-grid table tr th,
    .tft-design-2 .tft-footer-sections .tft-grid table tr td,
    .tft-site-footer h2,
    .tft-site-footer ul li,
    .tft-site-footer ul li a,
    .tft-site-footer table caption,
    .tft-site-footer table tr th,
    .tft-site-footer table tr td{
        color: <?php echo !empty($footer_text_color) ? esc_attr( $footer_text_color. ' !important' ) : '#222'; ?>;
    }

    .tft-design-2 .tft-footer-sections .tft-grid table,
    .tft-design-2 .tft-footer-sections .tft-grid table tr th,
    .tft-design-2 .tft-footer-sections .tft-grid table tr td,
    .tft-site-footer table,
    .tft-site-footer table tr th,
    .tft-site-footer table tr td{
        border-color: <?php echo !empty($footer_text_color) ? esc_attr( $footer_text_color. ' !important' ) : ''; ?>;
    }
