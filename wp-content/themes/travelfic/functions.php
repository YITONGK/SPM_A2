...
if ( ! defined( 'TRAVELFIC_VERSION' ) ) {
	...
	define( 'TRAVELFIC_VERSION', '1.1.8' );
}
...
<footer class="tft-site-footer tft-customizer-typography">
    ...
    <div class="tft-footer-copyright">
        <div class="tft-copyrgith-inner <?php echo esc_attr( apply_filters( 'travelfic_footer_tftcontainer', $travelfic_tftcontainer = '') ); ?>">
            <p class="tft-center">
            <?php
            $ultimate_hotel_booking_copyright = get_theme_mod('travelfic_customizer_settings_copyright_text', '© Copyright 2024 Tourfic Development Site by Themefic All Rights Reserved.');
                printf( esc_html__('%s', 'travelfic'), $ultimate_hotel_booking_copyright);
            ?>
            </p>
        </div>
    </div>
